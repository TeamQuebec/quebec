...
export default function ActivityPage() {
  ...
  return (
    <AppShell>
      {/* Was a hand-rolled copy of PageHeader. Two pages having their own
          version of the shared header is how a system drifts. */}
      <PageHeader
        eyebrow="Your portal"
        title="Activity"
        description="A read-only timeline of every check and permission change against your reference."
      />
